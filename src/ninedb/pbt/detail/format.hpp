...
namespace ninedb::pbt::detail
{
    struct Format
    {
        static void write_uint16(uint8_t *&address, uint16_t value)
        {
            ZonePbtFormat;
        ...
        static void write_uint32(uint8_t *&address, uint32_t value)
        {
            ZonePbtFormat;
        ...
        static uint8_t* read_uint16(uint8_t *address, uint16_t &value)
        {
            ZonePbtFormat;
        ...
        static uint8_t* read_uint32(uint8_t *address, uint32_t &value)
        {
            ZonePbtFormat;
        ...
        static uint8_t* read_uint64(uint8_t *address, uint64_t &value)
        {
            ZonePbtFormat;
