...
struct ContextReduceCallback : FunctionContext<void, const std::vector<std::string_view> &, std::string &>
{
    ContextReduceCallback(napi_env env, napi_value func)
        : FunctionContext<void, const std::vector<std::string_view> &, std::string &>(env, func, to_napi_args, from_napi_result) {}
